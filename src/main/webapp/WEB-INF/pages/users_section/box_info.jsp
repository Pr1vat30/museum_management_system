...
<section class="box-info">
  <ul id = "functions">
    <li>
      <a href="users-nav-servlet?pg=art"> <!-- Link per Esposizioni -->
        <i class="icon">🎨</i>
        <div class="text">
          <h3>Esposizioni</h3>
    ...
    <li>
      <a href="users-nav-servlet?pg=event"> <!-- Link per Eventi -->
        <i class="icon">📅</i>
        <div class="text">
          <h3>Eventi</h3>
    ...
    <li>
      <a href="users-nav-servlet?pg=notification"> <!-- Link per Visite Guidate -->
        <i class="icon">📰</i>
        <div class="text">
          <h3>News</h3>
